        ...
        <>
            {(epsData && animeData && newsAnimeData && ongoingAnime.status === "success") ? (
                ...
                <Helmet>
                    ...
                    <meta
                    name="description"
                    content={`Nonton Anime ${epsData.title} - Doyan Anime`}
                    />
                    ...
                    <meta property="og:site_name" content="Doyan Anime" />
                    <meta name="twitter:card" content="summary_large_image" />
                    <meta name="googlebot" content="index, follow" />
                    <meta name="twitter:title" content={`Nonton ${epsData.title} - Doyan Anime`} />
                    <meta name="twitter:card" content="summary_large_image" />
                    ...
                    content="Nonton Anime Online Sub Indo Gratis di Doyan Anime"
                    />
                    <meta
                    name="twitter:image"
                    content="https://raw.githubusercontent.com/MastayY/kumanime/main/public/logo.png"
